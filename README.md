...
- 🔭 I’m working on Software at Terminus/DemandScience as a Technical Lead Engineer focusing on Frontend. I work with my team on the client-side code for multiple applications and features.
    ...
    - Design Systems
    - Component libraries
    - Back of the frontend work
    - GitHub CI
    - Storybook/Chromatic/NX
    - Testing
    - Cross-team/timezone collaboration
    - Bug fixing
    - Triage
    ...
    - Typescript/Javascript/SCSS/HTML/Protobuff/and any other syntax/language I need to know to craft delightful experiences.
    - And more, so much more. `Frontend` :)
